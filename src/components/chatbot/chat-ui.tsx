...
export function ChatUI({ conversationId, initialMessages = [] }: ChatUIProps) {
  ...
  const fetchDocuments = async () => {
    try {
      ...
      console.log("ChatUI: fetched documents", data.documents)
    } catch (error) {
      console.error("ChatUI: Error fetching documents:", error)
    }
  }
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      console.log("ChatUI: assistant response complete:", responseText)
      router.refresh()
    } catch (error: any) {
